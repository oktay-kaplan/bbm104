...
public class MoveLeft {
    ...
    //If the next move is to the left, this function runs and performs the necessary operations.
    public static String move_left(int first_location1, int column, HashMap<Integer, String> map_board, HashMap<String, Integer> map_board2) {
        first_location = first_location1;
        int location = first_location1;
        String note1 = "Game over";
        String note2 = "Go On";
        if ((first_location + 1) % (column) == 2) {
            ...
            if (map_board.get(first_location).equals("R")) {
                ...
                if (map_board.get(first_location).equals("R")) {
                    ...
                    map_board.put(location, " ");map_board.put(first_location, "*");map_board2.put("*", first_location);
                    return note1;
                }
                else {
        ...
        } else if((first_location + 1) % (column) == 1) {
            first_location = location - 1;
            if (map_board.get(first_location).equals("R")) {
                map_board.put(first_location, "*");map_board2.put("*", first_location);map_board.put(location, "X");
                ScoreCalculate.calculate_score("R");
